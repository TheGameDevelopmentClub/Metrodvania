...
class CustomTiledImporterForBlocks : Tiled2Unity.ICustomTiledImporter
{
        ...
        IDictionary<string, string> props)
    {
		...
		//if (props ["spawn"] == "AppearingBlock") {
			//prefabPath = "Assets/Prefabs/AppearingBlock.prefab";
		//} else 
		if (props ["spawn"] == "WalkingEnemy") {
			prefabPath = "Assets/Prefabs/WalkingEnemy.prefab";
		}
		if (props ["spawn"] == "Turret") {
			prefabPath = "Assets/Prefabs/Turret.prefab";
		}
		if (props ["spawn"] == "Jem1") {
			prefabPath = "Assets/Prefabs/Jem1.prefab";
		}
		if (prefabPath != null) {
