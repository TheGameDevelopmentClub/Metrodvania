...
public class TileWindow : EditorWindow
{
	...
	private static bool addPolygonCollider;
	...
	void OnGUI()
	{
		...
		//GUILayout.BeginHorizontal();
		//addPolygonCollider = EditorGUILayout.Toggle(addPolygonCollider, GUILayout.Width(16));
		//EditorGUILayout.LabelField("Add Polygon Collider", GUILayout.Width(256));
		//GUILayout.EndHorizontal();
